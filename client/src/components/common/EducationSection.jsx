...
const EducationSection = () => (
  <section
    className="col-span-1 p-8 rounded-lg shadow-lg bg-gray-800"
    id="education"
  >
    ...
    <div className="grid grid-cols-1 gap-6">
      {education.map((ed, i) => (
        <div
          className="bg-gray-700 rounded-lg p-6 shadow-md transition-all duration-300 ease-in-out hover:shadow-xl hover:scale-105"
          key={i}
        >
